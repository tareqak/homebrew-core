class KafkaAT090 < Formula
  ...
  conflicts_with "kafka@0.80", :because => "Differing versions of the same formula"
  conflicts_with "kafka@0.11", :because => "Differing versions of the same formula"
